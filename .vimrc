...
"comment and uncimment text easily
...
set number
set expandtab
set st=6 sts=4 sw=4 et ai si ic
set noswapfile
set noshowmode
"set nu rnu
...
"use rm -rf ~/.vim/plugged/YouCompleteMe in bash

"Use UP and DOWN to move betvean items
